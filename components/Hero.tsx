          ...
          <div className="flex-1 w-full">
            <div className="grid grid-cols-2 gap-3">
              {heroProducts.map((p) => (
                ...
                >
                  {/* Package shape placeholder */}
                  <div
                    className={`${p.imgColor} w-11 h-16 rounded-t-sm rounded-b-xl mb-3 flex items-center justify-center`}
                  >
                    <div className="w-5 h-5 rounded-full bg-comma-red opacity-80" />
                  </div>
